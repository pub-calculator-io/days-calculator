<?php
/*
Plugin Name: Days Calculator by Calculator.iO
...
function display_ci_days_calculator(){
    $page = 'index.html';
    return '<h2><a href="https://www.calculator.io/days-calculator/" target="_blank"><img src="' . esc_url(plugins_url('assets/images/icon-48.png', __FILE__ )) . '" width="48" height="48"></a> Days Calculator</h2><div><iframe style="background:transparent; overflow: scroll" src="' . esc_url(plugins_url($page, __FILE__ )) . '" width="100%" frameBorder="0" allowtransparency="true" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + \'px\';" id="ci_days_calculator_iframe"></iframe></div>';
}
